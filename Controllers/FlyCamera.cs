...
namespace JusticeFramework.Controllers {
	...
	public class FlyCamera : MonoBehaviour {
		...
		private void Update()  {
			zoomDelta = UnityEngine.Input.mouseScrollDelta.y * zoomSpeed * Time.deltaTime * (UnityEngine.Input.GetKey(KeyCode.LeftShift) ? zoomModifier : 1);

			if (UnityEngine.Input.GetMouseButton(UNITY_DRAG_MOVE_MOUSE_BUTTON)) {
			...
			} else if (UnityEngine.Input.GetMouseButton(UNITY_ROTATE_MOUSE_BUTTON)) {
