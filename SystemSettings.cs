...
namespace JusticeFramework.Models.Settings {
    /// <summary>
    ...
    public static class SystemSettings {
        ...
        public static void ApplySettings() {
            // Set the resolution
            Screen.SetResolution(settings.screenWidth, settings.screenHeight, settings.useFullscreen, settings.screenRefreshRate);
        ...
        public static float GetScaledVolume(float value, EAudioType audioType) {
            ...
            switch (audioType) {
                ...
                case EAudioType.Dialogue:
                    scale = settings.voiceVolume;
                    break;
                case EAudioType.SoundEffect:
                    scale = settings.sfxVolume;
                    break;
                default:
                    scale = 1;
                    break;
            ...
            return value * scale * settings.masterVolume;
        }
